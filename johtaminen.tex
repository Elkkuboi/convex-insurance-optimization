...
\section{Johdanto}
Tässä dokumentissa johdetaan analyyttinen ratkaisu kahden jonon resurssien allokointiongelmalle. Tarkastelu etenee kahdessa vaiheessa: ensin johdetaan yksittäisen M/M/1-jonon odotusajan lauseke, minkä jälkeen ratkaistaan optimointiongelma KKT-ehdoilla. Lopuksi lasketaan vielä teoreettinen työntekijöiden allokointi, jota voimme käyttää myöhemmin simulaation vertailukohteena.
